...
hp0    = flightdata.Dadc1_alt.data(index1);      	  % pressure altitude in the stationary flight condition [m]
...
%x0=ones(1,20);
%% BOUNDARIES PHUGOID
lbp=      [-0.5,CXa, -1.5, CXq, -3, CZa, CX0, CZq, -5, -10, CZadot, Cmadot, CXde, CZde, Cma, muc, c, V0, KY2, Cmde]; %ones(1,20)*300*-1  ; [-500,-500, -500, CXq, -500, -500, CX0, CZq, -500, -500, CZadot, -100, -10, -10, Cma, muc, c, V0, KY2, Cmde]
ubp=      [0.5,CXa, -0.5, CXq, 3, CZa, CX0, CZq, 5, -5, CZadot, Cmadot, CXde, CZde, Cma, muc, c, V0, KY2, Cmde]; %ones(1,20)*300;       [500,500, 500, CXq, 500, 500, CX0, CZq, 500, 500, CZadot, 100, 10, 10, Cma, muc, c, V0, KY2, Cmde]
%% PHUGOID
...
lbsp=      [CXu,CXa, CZ0, CXq, CZu, -9, CX0, -7, Cmu, -10, CZadot, -0.2, CXde, CZde, Cma, muc, c, V0, KY2, Cmde]; 
ubsp=      [CXu,CXa, CZ0, CXq, CZu, -3, CX0, -5, Cmu, -5, CZadot, 0.2, CXde, CZde, Cma, muc, c, V0, KY2, Cmde];
