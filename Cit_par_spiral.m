...
timebegin =  3220.5; %changes for each motion. Here Spiral starting time.
[d,index] = min(abs(flightdata.time.data-timebegin));
stop = 2887; %changes for each motion. Here Spiral stop index.
...
Cma    = -0.4157;            % longitudinal stabilty [ ]
Cmde   = -0.9844;            % elevator effectiveness [ ]
