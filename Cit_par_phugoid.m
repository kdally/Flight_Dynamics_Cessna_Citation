...
hp0    = flightdata.Dadc1_alt.data(index1)*0.3048;      	  % pressure altitude in the stationary flight condition [m]
V0     = flightdata.Dadc1_tas.data(index1)*0.51444444444;            % true airspeed in the stationary flight condition [m/sec]
...
CLa    = 0.077429*180/pi;            % Slope of CL-alpha curve [ ]
...
Clb    = -0.1404; %found by spiral
Clp    = -0.9450; %found by aperiodic roll
Clr    = +0.5040; %found by spiral
Clda   = -0.1830; %found by aperiodic roll
Cldr   = +0.03440;

Cnb    =  +0.1438; %found by spiral
Cnbdot =   0     ;
Cnp    =  -0.0602;
Cnr    =  -0.1666; %from spiral
Cnda   =  -0.0120;
Cndr   =  -0.0939;
